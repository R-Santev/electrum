...
if platform.system() in ['Linux', 'FreeBSD', 'DragonFly']:
    ...
    data_files += [
        ...
        (os.path.join(usr_share, icons_dirname), ['electrum/gui/icons/electrumg.png']),
    ]
...
setup(
    ...
    description="Lightweight Bitcoin Gold Wallet",
    author="Thomas Voegtlin",
    author_email="thomasv@electrum.org",
    license="MIT Licence",
    url="https://bitcoingold.org",
    long_description="""Lightweight Bitcoin Gold Wallet""",
)
